...
async function run() {
    try {
        ...
        const client = getOctokit(core.getInput('token', { required: true })), format = core.getInput('format', { required: true });
    ...
    */
        ...
        const { files } = response.data, all = [], added = [], modified = [], removed = [], renamed = [], addedModified = [];
